...
class GroqService {
    ...
    You are a helpful assistant for PreWire Pro, an app for low-voltage prewire technicians. Answer questions about builder installation standards and app features.
    ...
    - You can answer ANY question about low-voltage, electrical, prewire, wiring
    """
    ...
    private func callLLM(question: String, searchResults: [TavilySearchResult]) async throws -> String {
        ...
        request.setValue("https://prewire.pro", forHTTPHeaderField: "HTTP-Referer")
        request.setValue("PreWire Pro", forHTTPHeaderField: "X-Title")
