...
struct PreWireProApp: App {
    ...
    init() {
        ...
        do {
            ...
            let cloudConfig = ModelConfiguration(
                "CloudSync",
                schema: syncedSchema,
                cloudKitDatabase: .private("iCloud.PalLow-Voltage.PreWire-Pro")
            )
            print("☁️ CloudKit sync enabled with container: iCloud.PalLow-Voltage.PreWire-Pro")
            ...
            do {
                ...
                let storeURL = containerURL?.appendingPathComponent("PreWirePro.store")
    ...
    var body: some Scene {
        ...
        .backgroundTask(.appRefresh("com.prewire.emailcheck")) {
