...
struct AssistantChatView: View {
    ...
    private let brandGreen = Color(red: 76/255, green: 140/255, blue: 43/255)
    private let assistant = PalFieldAssistant.shared
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("PalField Assistant")
...
struct WelcomeMessage: View {
    ...
    var body: some View {
        VStack(spacing: 16) {
            ...
            Text("Ask me anything about low-voltage, palfield, wiring, or builder standards. I'll research the web to find answers.")
                .font(.subheadline)
