...
PreWire Pro now supports importing jobs from email! There are three ways to import jobs from emails:
...
3. **Run Shortcut** → "Import Job from Email" (provided by PreWire Pro)
...
4. Add action: **Run Shortcut** → Select "Import PreWire Job"
...
- Runs: Daily
- Action: Run "Import PreWire Job" shortcut
